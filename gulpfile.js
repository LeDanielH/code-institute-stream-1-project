...
gulp.task('modernizr', ['create-templateCache'], function() {
	gulp.src([
...
gulp.task('watch', function () {
	...
	gulp.watch(['src/**/*.html'], ['process-html', 'process-styles', 'create-templateCache']);
	gulp.watch(['src/data/**/*.json'], ['process-scripts', 'process-html', 'process-styles']);
